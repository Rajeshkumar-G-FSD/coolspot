...
export default function GoogleReviewCarousel() {
  ...
  const startTimer = useCallback(() => {
    ...
    timerRef.current = window.setInterval(next, 2000);
  }, [next]);
    ...
    <div className="w-full py-8 select-none">
      ...
      <div className="flex flex-col items-center mb-6 gap-1">
        <div className="flex items-center gap-2">
          <GoogleG />
          <span className="text-sm font-bold text-slate-600 dark:text-slate-300">Google Reviews</span>
          <StarRow />
          <span className="text-sm font-black text-[#001a52] dark:text-[#dbe1ff] ml-0.5">5.0</span>
        </div>
        <p className="text-[11px] text-slate-400 tracking-wide">Based on verified guest experiences</p>
      </div>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-white/10 shadow-xl p-5 h-full">
              ...
              <div className="flex items-start justify-between mb-2">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <p className="text-[13px] font-bold text-slate-800 dark:text-slate-100 leading-tight">{review.name}</p>
                ...
                <span className="text-base font-black text-slate-700 dark:text-slate-200">5/5</span>
              </div>
              ...
              {/* Review text */}
              <p className="text-[11px] text-slate-600 dark:text-slate-300 leading-relaxed mb-3 line-clamp-3">{review.text}</p>
